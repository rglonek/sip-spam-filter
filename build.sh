...
tar -zcvf bin/sip-spam-filter-linux-amd64.tar.gz sip-spam-filter
...
tar -zcvf bin/sip-spam-filter-linux-arm64.tar.gz sip-spam-filter
...
tar -zcvf bin/sip-spam-filter-darwin-amd64.tar.gz sip-spam-filter
...
tar -zcvf bin/sip-spam-filter-darwin-arm64.tar.gz sip-spam-filter
